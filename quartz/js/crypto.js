...
// Adapted from seaof.glass/share/js/crypto.js + transfer.js
...
// String encrypt/decrypt (text → base64)
...
// Binary encrypt/decrypt (ArrayBuffer → ArrayBuffer)
...
export async function decryptBinary(data, key) {
